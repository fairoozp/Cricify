            ...
            public void onClick(View view) {
                ...
                if (startOrNot) {
                    if (over != inputOver) {
                        clearThisOverCountUI();
                        int byes;
                        if (eT_Byes.getText().toString().equals("")) {
                            byes = 0;
                        } else {
                            byes = Integer.parseInt(eT_Byes.getText().toString());
                        }
//                    int byes = Integer.parseInt(eT_Byes.getText().toString());
    ...
    public void inputFromUI()
    {
        ...
        if (inputOver2.equals("")) {
            inputOver=Double.parseDouble("0");
        } else {
